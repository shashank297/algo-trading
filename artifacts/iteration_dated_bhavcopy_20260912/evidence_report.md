...
- Source records: 371; source hash errors: 0.
- Source tiers: A1=367, B1=1.
- Event observations: 1482; canonical events: 640.
- Monthly snapshot rows: 21650 across 108 checkpoints.
- Durable identity mappings: 4087 certified; 0 remain manual-review candidates.
- Coverage gaps or non-200 checkpoints: 68 campaign months.
- NSE sessions checked: 3609; replay count range: 0..136.
- Blocker ledger rows: 3853; known_at unresolved canonical events: 0.
