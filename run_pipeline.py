...
# - Historical Baseline v1 Frozen Hash: 8330bb013ffd1d22acb2c60d715066a43b239cd35b382e772c4a7d47c7d72a3c
# - Canonical Baseline v2 Hash (v1.1.0): 9839425d1c770c2b25744b110122c7b44cd3d7e4ee0e94dbb942dfa07f9d2092
...
CAMPAIGN_GOVERNED_RISK_POLICY_HASHES = frozenset({
    CAMPAIGN_CANONICAL_RISK_POLICY_HASH,
    CAMPAIGN_FROZEN_RISK_POLICY_HASH,
})
...
def _baseline_preflight(config: dict[str, Any], *, mode: str) -> tuple[dict[str, Any], tuple[str, ...]]:
    ...
    elif risk_hash == CAMPAIGN_FROZEN_RISK_POLICY_HASH:
        details["risk_policy_governance"] = "HISTORICAL_BASELINE_V1"
    else:
